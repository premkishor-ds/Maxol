          ...
          <div className={"opendot green-dot"}>
            ...
            <div className="hours-info ">
              ...
              <span className="lowercase">
                {OpenStausFunctions.formatTime(currentInterval.start).replace(':00','').replace(" ", "")}
              </span>{" "}
              to{" "}
              <span className="lowercase">
                {OpenStausFunctions.formatTime(currentInterval.end).replace(':00','').replace(" ", "")}
              </span>{" "}
            </div>
          </div>
        );
          ...
          <div className={"closeddot 4"}>
            <div className="red-dot">
              ...
              <div className="hours-info ">
                ...
                {"Opens at "}
                <span className="lowercase">
                  {OpenStausFunctions.formatTime(nextInterval.start).replace(':00','').replace(" ", "")}
                </span>{" "}
                {week[Day]}
              </div>
            </div>{" "}
  ...
  return (
    <>
      {props.hours && props.hours.reopenDate ? (
        ...
        <div className="closeing-div notHighlight w-full">  
          {props.infowindow ? (
            OpenStausFunctions.formatOpenNowString(props.hours, props.timezone)
          ) : (
            <OpenCloseBlock hoursData={props.hours} timeZone={props.timezone} />
          )}
        </div>
      ) : (
        <div className="closeddot notHighlight 1">
          <div className="red-dot notHighlight">
            ...
            <div className="hours-info font-second-main-font notHighlight">
              Closed
            </div>{" "}
          </div>
        </div>
