...
if(openObject.stateset){
        ...
        <div className={"opendot notHighlight green-dot"}>
          ...
          <div className="hours-info ">
            ...
            <span className="lowercase notHighlight">
              {formatTime(openObject.start).replace(':00','').replace(" ", "")}
            </span>
            <span className="lowercase notHighlight"> to </span>
            <span className="lowercase notHighlight">
              {formatTime(openObject.end).replace(':00','').replace(" ", "")}
            </span>
          </div>
        </div>
      );
  ...
  return   <div className="closeddot notHighlight 2"><Skeleton count={1}/></div>
}
}
