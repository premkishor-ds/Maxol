...
const LocationCard: CardComponent<Location> = (props: any) => {
  ...
  return props.result.map((result: any, keyindex: number) => {
    ...
    const name: any = result.rawData.name;
              ...
              <div className="lp-param-results lp-subparam-hours">
                ...
                <div className="icon-row content-col address-with-availablity notHighlight">
                  ...
                  <div className="availablity-content">
                    <Availability
                      c_openForShoppingAvailibility={result.rawData.c_open_for_shopping}
                      c_clickCollectAvaliability={result.rawData.c_click_collect_availability}
                      c_parking_facilities={result.rawData.c_parking_facilities}
