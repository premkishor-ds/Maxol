...
export const config: TemplateConfig = {
  stream: {
    ...
    fields: [
      ...
      "meta",
      "name",
      "c_businessOpportunityTitle",
      "c_businessOpportunityLists",
      "c_opportunity",
      "c_opportunitiesText",
      "c_opportunitiesCta",
      "c_licenseeLists"
    ...
    filter: {
      entityIds: ["business-Opportunity"],
    },
    localization: {
      locales: ["en"],
      primary: false,
...
const Business_Opportunity: Template<TemplateRenderProps> = ({
  path,
  __meta,
  document,
}) => {
...
export default Business_Opportunity;